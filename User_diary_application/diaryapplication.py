...
from User_diary_application.exception import InputMismatchException, NotFoundException, IncorrectPinException
...
class DiaryApplication:
    ...
    def delete_entry(self):
        try:
            ...
            self.my_diary.delete_entry_by_id(int(entry_id))
